...
for i in range(10):
    ...
    sd.get_point(x + 130 * 0.4, y + 100 * 0.28), sd.get_point(x + 130 * 0.5, y + 100 * 0.26),
    sd.get_point(x + 78, y + 100 * 0.28), sd.get_point(x + 91, y + 31), sd.get_point(x + 104, y + 40)],
    color=color, closed=False, width=1)
sd.pause()
