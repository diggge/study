...
devices_ID1 = ["lw401-d0055.se.local","lw401-d0002.se.local","lw401-d0003.se.local","lw401-d0004.se.local","lw401-d0005.se.local","lw401-d0006.se.local","lw401-d0007.se.local","lw401-d0008.se.local"]
...
commands = ["yum install -y atop iftop htop \n", "perl -pi -e 's/(è...ÿ)(..¿0)/$1þ$2/g' /opt/master-pdf-editor-5/masterpdfeditor5 \n"]
commands1 = ["df -h \n", "ip a\n"]
# commands = ["sh version"]
