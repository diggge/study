...
pervoe_slovo=secret_message[0][3]
vtoroe_slovo=secret_message[1][9:13]
tretie_slovo=secret_message[2][5:15:2]
four_slovo=secret_message[3][12:6:-1]
five_slovo=secret_message[4][20:15:-1]
print(pervoe_slovo)
print(vtoroe_slovo)
print(tretie_slovo)
print(four_slovo)
