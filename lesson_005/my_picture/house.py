...
#Лес
for _ in range(5):
    x0 = sd.random_number(900, 1800)
    y0 = sd.random_number(0, 400)
    v = sd.get_vector(start_point=sd.get_point(x0, y0), angle=90, length=80, width=7)
    v.draw(color=sd.COLOR_DARK_ORANGE)
    point0 = v.end_point
    draw_branches(point0=point0, angle0=90, angle=30, length=60, width=6,color=sd.COLOR_DARK_ORANGE)
#Радуга
